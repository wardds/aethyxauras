...
AAENV.lib.GetSpellCooldownAndCharges = function(id, gcdInfo)
  ...
  if (charges == nil) then -- spell does not work with charges
    ...
    matchesGCD = duration == nil or duration == 0 or start == nil or (duration == gcdInfo.duration and start == gcdInfo.start)
  ...
  return start, duration, charges, maxCharges, modRate, matchesGCD
end
