...
AAENV.spells.WARRIOR.Arms = {
  ...
  { spellName = "Rend", group = 1 },
  { spellName = "Cleave", group = 1 },
  ...
  { spellName = "Deadly Calm", buffName = "Deadly Calm", group = 2 },
  ...
  { spellName = "Defensive Stance", buffName = "Defensive Stance", group = 2 },
